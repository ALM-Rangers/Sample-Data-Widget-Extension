...
export class SampleDataView implements Controller.INotifyCallBack{

    private controller: Controller.ISampleDataController;
    private templates: SampleDataContracts.ISampleDataTemplate[];
    private populatedTemplate: SampleDataContracts.ISampleDataTemplate;
    private lstPopulatedTemplates: SampleDataContracts.ISampleDataTemplate[];
    private progresBar: ProgressBar.ProgressBar;
    private cbo: Combos.Combo;
    ...
    public InitView(ctrl: Controller.ISampleDataController) {
        ...
        view.controller.LoadTemplates().then(
            data => {
                $("#InitialLoad").hide();
                ...
                $("#Create").show();
                view.templates = data;
                    var cboTemplateOptions = <Combos.IComboOptions>{
                    width: "100%",
                    source: view.templates.map(i => {
                        return i.Name;
                    }),
                };
        ...
        $('#Create').on("click", function () {
            ...
            var selectedTemplate = view.templates.filter(t => {
            ...
            view.controller.Populate( selectedTemplate, view.progresBar).then(
                tmpl => {
        ...
        $('#Delete').on("click", function () {
            ...
            view.controller.Remove(view.populatedTemplate, view.progresBar).then(
                tmpl => {
                    if (view.progresBar.allTasksPassed()) {
                        view.showCreate = false;
                        view.lstPopulatedTemplates = view.controller.PopulatedTemplates;
        ...
        $('#DeleteFailed').on("click", function () {
            ...
            view.controller.Remove(view.populatedTemplate, null).then(
                tmpl => {
                    view.showCreate = false;
                    view.lstPopulatedTemplates = view.controller.PopulatedTemplates;
                    if (view.lstPopulatedTemplates.length > 0) {
        ...
        $("#TryItLink").on("click.OpenInstructions", eventData => {
    ...
    public LoadTemplates() {
        ...
        view.controller.LoadTemplates().then(
            data=> {
                ...
                view.cbo.setSource(view.templates.map(i => {
                    return i.Name;
                }));
                view.cbo.setSelectedIndex(0);
                view.showPanels();
    ...
    public OpenInstructionsPopup():boolean{
