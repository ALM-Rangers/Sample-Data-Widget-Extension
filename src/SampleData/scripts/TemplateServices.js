define(["require", "exports"], function (require, exports) {
    ...
    var TemplateService = (function () {
        ...
        ;
        TemplateService.prototype.getTemplateSettings = function () {
            var deferred = $.Deferred();
            var svc = this;
            this.init().then(function (a) {
                svc.dataService.getValue("TemplateSource", { scopeType: "Account", defaultValue: "Extension" }).then(function (settings) {
                    deferred.resolve(settings);
                });
            });
            return deferred.promise();
        };
        TemplateService.prototype.setTemplateSettings = function (value) {
            var deferred = $.Deferred();
            var svc = this;
            this.init().then(function (a) {
                svc.dataService.setValue("TemplateSource", value, { scopeType: "Account", defaultValue: "Extension" }).then(function (settings) {
                    deferred.resolve(settings);
                });
            });
            return deferred.promise();
        };
        TemplateService.prototype.LoadCustomTemplates = function () {
            var deferred = $.Deferred();
            var service = this;
            ...
            initPromise.then(function (data) {
                ...
                console.log("Before getDocuments"),
                    service.dataService.getDocument("CustomTemplates", "CustomTemplates").then(function (doc) {
        ...
        ;
        TemplateService.prototype.SaveCustomTemplates = function (templates) {
            var deferred = $.Deferred();
            var service = this;
            console.log("SaveCustomTemplate called");
            try {
                var templateNames = "";
                templates.forEach(function (template) { templateNames = templateNames + ";" + template.Name; });
            ...
            initPromise.then(function (data) {
                ...
                service.dataService.setDocument("CustomTemplates", obj).then(function (doc) {
        ...
        ;
        TemplateService.prototype.savePopulatedTemplates = function (templates) {
            var deferred = $.Deferred();
            var service = this;
            var vsoContext = VSS.getWebContext();
            // Get the data service
            ...
            this.init().then(function (dataService) {
                // set an account-scoped document in a collection
                service.dataService.setDocument(service.getDocumentCollectionUrl(vsoContext, ""), doc2Save).then(function (doc) {
        ...
        TemplateService.prototype.getPopulatedTemplates = function () {
            var deferred = $.Deferred();
            var service = this;
            var vsoContext = VSS.getWebContext();
            this.init().then(function (dataService) {
                // set an account-scoped document in a collection
                service.dataService.getDocument(service.getDocumentCollectionUrl(vsoContext, ""), "PopulatedTmp").then(function (doc) {
        ...
        TemplateService.prototype.getDocumentCollectionUrl = function (vsoContext, serviceName) {
            // Limitied to 50 characters :(
            return vsoContext.project.id + '-' + serviceName;
        };
        TemplateService.prototype.getDefaultTemplates = function () {
