...
var GitApi = (function (_super) {
    ...
    * @param {string} project - Project ID or project name
    */
    GitApi.prototype.getPullRequestThread = function (repositoryId, pullRequestId, threadId, project) {
        var _this = this;
        var deferred = Q.defer();
        var onResult = function (err, statusCode, PullRequestThread) {
            if (err) {
    ...
    * @param {string} project - Project ID or project name
    */
    GitApi.prototype.getThreads = function (repositoryId, pullRequestId, project) {
        var _this = this;
        var deferred = Q.defer();
    ...
    */
    GitApi.prototype.getRefs = function (repositoryId, project, filter, includeLinks) {
        var _this = this;
        var deferred = Q.defer();
    ...
    * @param {boolean} includeLinks
    */
    GitApi.prototype.getRepositories = function (project, includeLinks) {
        var _this = this;
        var deferred = Q.defer();
